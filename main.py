...
print( )
time.sleep(0.5)
print('                   [Help : Less ratio lower will be the size, More ratio better will be the quality]')
print('                                       [Recommended Ratio : B/w [30% to 80%]')
print( )

selectquality = input("Enter Image Quality ratio b/w [0 to 100] : ")
